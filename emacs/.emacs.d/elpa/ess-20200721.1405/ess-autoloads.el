...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-custom" '("R-" "S+" "S-" "comint-highlight-prompt" "ess-" "inferior-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-gretl" '("ess-gretl-" "gretl-" "inferior-gretl-args")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-julia" '("ac-source-ess-julia-objects" "company-ess-julia-objects" "ess-" "inferior-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-r-mode" '("R-" "ess-" "inferior-ess-r-" "run-ess-r-newest")))
...
If called interactively, enable Ess-Roxy mode if ARG is positive,
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-s-lang" '("ess-" "inferior-S-language-start" "s-")))
